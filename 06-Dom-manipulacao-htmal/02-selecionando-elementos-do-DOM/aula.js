/*Na aula anterior, exploramos os métodos de seleção de elementos no DOM, tanto modernos quanto tradicionais. 
Agora que você sabe como acessar esses elementos, estamos prontos para dar o próximo passo.

Nesta aula, vamos nos concentrar na modificação de elementos do DOM. Isso inclui alterar o texto e o conteúdo de 
um elemento, modificar seus atributos e estilos e adicionar ou remover elementos dentro do documento HTML. 
Essas ações permitem que você crie interfaces dinâmicas e responsivas, que podem reagir ao comportamento do 
usuário na página tornando suas páginas web verdadeiramente interativas.

Então, sem mais delongas, bora começar!

Modificação de Texto e Conteúdo
A manipulação de texto e conteúdo em elementos HTML é uma parte fundamental da programação em JavaScript para a web. 
Permite que você atualize o conteúdo de uma página sem a necessidade de recarregá-la, criando uma experiência de 
usuário mais fluida e dinâmica.
